...
namespace ImageProcessing
{
    public class IDL
    {
        public static void ProcessingOrigionData(string Pro_Name,string File_Directory, string Date_Time, string EVF_FileName, string SNOW_FILENAME,AxMapControl _MapControl)
        {
